 ...
 * Override {@link org.codepond.wizardroid.WizardFragment#onSetup()} to set up the wizard's flow
 * and optionally {@link org.codepond.wizardroid.WizardFragment#onWizardComplete()} ()} to handle wizard's finish event.
 * Extend this class to implement your own custom wizard layout and user {@link org.codepond.wizardroid.Wizard} API to
 * control the wizard. Typically, you'd call {@link org.codepond.wizardroid.Wizard#goNext()} and {@link org.codepond.wizardroid.Wizard#goBack()}
 ...
 * own, then wizard context persistence is totally up to you by implementing {@link org.codepond.wizardroid.persistence.ContextManager} and passing
 * an instance of it when you construct {@link org.codepond.wizardroid.Wizard}.
 */
public abstract class WizardFragment extends Fragment implements Wizard.WizardCallbacks {
    ...
    /**
     * @param contextManager {@link org.codepond.wizardroid.persistence.ContextManager}, responsible for persisting variable values between steps
     */
    ...
    /**
	 * Set up the Wizard's flow. Use {@link org.codepond.wizardroid.WizardFlow.Builder} to create the Wizard's flow.
	 */
